...
choices.each do |page|
    Page.create("page_id": page[:pageid], "choice1": page[:choice1], "choice2": page[:choice2], "outpath1": page[:outpath1], "outpath2": page[:outpath2], "page_text": texts.sample()[:text], "book_id": 1)
end
choices.each do |page|
    Page.create("page_id": page[:pageid], "choice1": page[:choice1], "choice2": page[:choice2], "outpath1": page[:outpath1], "outpath2": page[:outpath2], "page_text": texts.sample()[:text], "book_id": 2)
end
choices.each do |page|
    Page.create("page_id": page[:pageid], "choice1": page[:choice1], "choice2": page[:choice2], "outpath1": page[:outpath1], "outpath2": page[:outpath2], "page_text": texts.sample()[:text], "book_id": 3)
end
choices.each do |page|
    Page.create("page_id": page[:pageid], "choice1": page[:choice1], "choice2": page[:choice2], "outpath1": page[:outpath1], "outpath2": page[:outpath2], "page_text": texts.sample()[:text], "book_id": 4)
end
choices.each do |page|
    Page.create("page_id": page[:pageid], "choice1": page[:choice1], "choice2": page[:choice2], "outpath1": page[:outpath1], "outpath2": page[:outpath2], "page_text": texts.sample()[:text], "book_id": 5)
end
choices.each do |page|
    Page.create("page_id": page[:pageid], "choice1": page[:choice1], "choice2": page[:choice2], "outpath1": page[:outpath1], "outpath2": page[:outpath2], "page_text": texts.sample()[:text], "book_id": 6)
end
choices.each do |page|
    Page.create("page_id": page[:pageid], "choice1": page[:choice1], "choice2": page[:choice2], "outpath1": page[:outpath1], "outpath2": page[:outpath2], "page_text": texts.sample()[:text], "book_id": 7)
end
choices.each do |page|
    Page.create("page_id": page[:pageid], "choice1": page[:choice1], "choice2": page[:choice2], "outpath1": page[:outpath1], "outpath2": page[:outpath2], "page_text": texts.sample()[:text], "book_id": 8)
end
choices.each do |page|
    Page.create("page_id": page[:pageid], "choice1": page[:choice1], "choice2": page[:choice2], "outpath1": page[:outpath1], "outpath2": page[:outpath2], "page_text": texts.sample()[:text], "book_id": 9)
end
choices.each do |page|
    Page.create("page_id": page[:pageid], "choice1": page[:choice1], "choice2": page[:choice2], "outpath1": page[:outpath1], "outpath2": page[:outpath2], "page_text": texts.sample()[:text], "book_id": 10)
end


  

# WE JUST FETCH AND IN OUR SECOND .THEN
# {
#     id: 10,
#     pages: [
#         p1,2,3,4,5,6,... 50, the end
#     ]
# }